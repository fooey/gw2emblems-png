...
export function linearBurnPixel(rgbaSource, rgb) {
    if (rgbaSource.a) {
        ...
        const result = _.merge(rgbaSource, newRgb);

        console.log(rgbaSource.a, rgb, newRgb, result);
...
export function darkenPixel(rgbaSource, lightnessPct) {
    if (rgbaSource.a) {
        return {
            i: rgbaSource.i,
            r: rgbaSource.r * lightnessPct,
            g: rgbaSource.g * lightnessPct,
            b: rgbaSource.b * lightnessPct,
            a: rgbaSource.a,
        };
    }
    else {
